        ...
        function (_React$Component) {
          ...
          function _class(props) {
            ...
            if (options.actions) {
              Object.keys(options.actions).forEach(function (actionKey) {
                ...
                if (Array.isArray(Action["extends"]) && !hasExtendAction.includes(Action)) {
                ...
                Object.keys(_this.lifeCycle).forEach(function (key) {
                  if (typeof actionInstance[key] === 'function') {
                    _this.lifeCycle[key].push(actionInstance[key].bind(actionInstance));
                  }
                }); // 实例化action

                _this.action[actionKey] = actionInstance; // 给action挂载model方法
                ...
                actionInstance.actions = _this.action; // 拿到组件实例
              ...
              _this.lifeCycle['didAllInstance'].forEach(function (fn) {
            ...
            if (options.models) {
              ...
              models.forEach(function (model) {
                ...
                _this.models[model.name] = model.data;
          ...
          _createClass(_class, [{
            ...
            value: function shouldComponentUpdate() {
              var flag = true;
              this.lifeCycle['shouldUpdate'].forEach(function (fn) {
            ...
            value: function componentWillUnmount() {
              this.lifeCycle['willUnMount'].forEach(function (fn) {
                typeof fn === 'function' && fn();
              });
            }
          }, {
            ...
            value: function componentDidUpdate() {
              this.lifeCycle['didUpdate'].forEach(function (fn) {
                typeof fn === 'function' && fn();
              });
            }
          }, {
            ...
            value: function componentDidMount() {
              this.lifeCycle['didMount'].forEach(function (fn) {
                typeof fn === 'function' && fn();
              });
            }
          }, {
            ...
            value: function render() {
              return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(CustomComponent, {
                action: this.action,
                state: this.state,
                props: _objectSpread({}, this.props, {}, this.models)
              });
            }
          }]);
